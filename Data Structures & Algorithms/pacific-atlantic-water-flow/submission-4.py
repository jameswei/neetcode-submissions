class Solution:
    def pacificAtlantic(self, heights: List[List[int]]) -> List[List[int]]:
        ...
        def dfs(heights: List[List[int]], coordinates: tuple[int, int], cells: Set):
